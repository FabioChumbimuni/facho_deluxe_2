///////////////////////////////////////////////
// DIAGRAMA COMPLETO DE BASE DE DATOS - FACHO DELUXE v2
/////////////////////////////////////////////

// ✅ ÚLTIMA ACTUALIZACIÓN: 2025-12-02
// Este diagrama incluye TODAS las tablas personalizadas del proyecto.
...
Table olt {
  ...
  // ✅ TIMESTAMPS
  created_at timestamp [note: "Fecha de creación"]
  updated_at timestamp [note: "Fecha de última actualización"]
...
Table index_formulas {
  ...
  indexes {
    (marca_id, modelo_id) [unique, name: 'index_formulas_marca_modelo_unique']
...
Ref: snmp_task_templates.function_id > snmp_task_functions.id [delete: restrict] // No eliminar función si hay templates
...
Ref: snmp_workflow_template_nodes.oid_id > oids.id [delete: restrict] // No eliminar OID si está en uso
...
Ref: snmp_workflow_nodes.template_id > snmp_task_templates.id [delete: restrict] // No eliminar template si está en uso
